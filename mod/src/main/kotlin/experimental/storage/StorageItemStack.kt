...
class StorageItemStack(icon: ItemStack, price: Long, title: String, description: String, hover: String) :
    StorageNode<ItemElement>(price, title, description, hover, item { stack = icon }) {
