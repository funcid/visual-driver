...
<br>
По умолчанию, если вы загружаете минимум 2 набора модов - моды сжимаются и игроку отправляется уменьшенный мод. Исходники компрессора https://github.com/cristalix-arcades/mod-compressor, компрессию можно убрать написав перед наборами `false` (не рекомендуется).
...
<h3>Режим DUGUB (Для удобной разработки)</h3> 
