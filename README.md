# Cristalix Animation API DOCS (актуальная версия 1.0.11)
...
1.2. Добавить `implementation 'me.func:animation-api:1.0.11'` в ваш `build.gradle`, для получения ключа к репозиторию, пишите <a href="https://vk.com/funcid">@funcid</a> или <a href="https://vk.com/delfikpro">@delfikpro</a>.<br>
1.3. Библиотека работает на языках `Java`, `Kotlin`, `Groovy`<br>
1.4. <b>Совместима со всеми версиями Core API и Paper</b><br>
1.5. Есть `implementation 'me.func:animation-api:1.0.11-shaded'` версия без kotlin
